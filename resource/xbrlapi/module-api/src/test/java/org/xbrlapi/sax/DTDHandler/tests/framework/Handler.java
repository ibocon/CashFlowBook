...
public class Handler extends DefaultHandler implements DTDHandler, DeclHandler {
    ...
    private void serialize(Node what) throws Exception {

        DOMImplementationRegistry dir = DOMImplementationRegistry.newInstance();
        DOMImplementationLS di = (DOMImplementationLS) dir.getDOMImplementation("LS");
        LSSerializer writer = di.createLSSerializer();
        System.out.println(writer.writeToString(what));
/*        
