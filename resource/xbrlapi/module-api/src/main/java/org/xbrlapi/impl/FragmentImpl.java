...
public class FragmentImpl extends XMLImpl implements Fragment {
     ...
     */
    public List<LabelResource> getLabels(List<String> languages, List<String> resourceRoles) throws XBRLException {
     ...
     */
    public List<LabelResource> getLabels(List<String> languages, List<String> labelRoles, List<String> linkRoles) throws XBRLException {
        ...
        for (String linkRole: linkRoles) {
            for (String labelRole: labelRoles) {
                for (String language: languages) {
